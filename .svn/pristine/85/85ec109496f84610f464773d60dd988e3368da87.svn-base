...
+ (void)showWithText:(NSString *)text_{
    [WTYToast showWithText:text_ duration:DEFAULT_DISPLAY_DURATION];
}

+ (void)showWithText:(NSString *)text_
            duration:(CGFloat)duration_{
    WTYToast *toast = [[WTYToast alloc] initWithText:text_];
...
+ (void)showWithText:(NSString *)text_
    ...
    [WTYToast showWithText:text_  topOffset:topOffset_ duration:DEFAULT_DISPLAY_DURATION];
}
...
+ (void)showWithText:(NSString *)text_
    ...
    [WTYToast showWithText:text_  bottomOffset:bottomOffset_ duration:DEFAULT_DISPLAY_DURATION];
}
