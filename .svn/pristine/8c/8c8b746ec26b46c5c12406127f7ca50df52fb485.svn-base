...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UIColor *bColor = [UIColor colorWithRed:255.0/255.0 green:255.0/255.0 blue:255.0/255.0 alpha:0.2];
    ...
    if (peripheral.state == 2) {
        ...
        cell.detailTextLabel.text=CustomLocalizedString(@"StateConnected", nil);
        ...
        cell.detailTextLabel.text=CustomLocalizedString(@"StatedisConnected", nil);
    }
