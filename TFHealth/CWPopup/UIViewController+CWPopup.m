...
- (void)presentPopupViewController:(UIViewController *)viewControllerToPresent animated:(BOOL)flag completion:(void (^)(void))completion {
    if (self.popupViewController == nil) {
        ...
        viewControllerToPresent.view.layer.shadowColor = [UIColor whiteColor].CGColor;
        viewControllerToPresent.view.layer.shadowRadius = 100.0f;
        viewControllerToPresent.view.layer.shadowOpacity = 0.05f;
