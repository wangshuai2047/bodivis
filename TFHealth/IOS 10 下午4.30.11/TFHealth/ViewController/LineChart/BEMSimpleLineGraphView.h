...
@property (strong,nonatomic) UIView * barGraph;
@property (assign,nonatomic) float barGraphWidth;
@property (strong, nonatomic) UIColor * barGraphColor;

@property (strong, nonatomic) UIFont *labelFont;
@property (strong, nonatomic) NSArray * addLineArray;
@property (strong, nonatomic) NSArray * addWaterLineArray;
@property (strong, nonatomic) NSArray * addMuscleLineArray;
@property (strong, nonatomic) NSMutableArray *ArrayOfColors;

@property (strong, nonatomic) UIButton * bubbleButton;
...
@property (strong,nonatomic)UIColor * colorVerticalLine;
