...
@property (strong, nonatomic,readwrite) NSCache *memCache;
@property (strong, nonatomic,readwrite) NSString *diskCachePath;
@property (SDDispatchQueueSetterSementics, nonatomic,readwrite) dispatch_queue_t ioQueue;
