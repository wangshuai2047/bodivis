...
- (void)notifyProgressChange
{
    ...
    if (self.labelTextBlock) {
        ...
        if (textFormat==nil|| [textFormat isEqualToString:@""]) {
        ...
        text = [NSString stringWithFormat:textFormat, self.progressCounter];
    }
	
	self.accessibilityValue = text;
	self.label.text = text;
	self.label.font=[UIFont fontWithName:@"Helvetica" size:42];
