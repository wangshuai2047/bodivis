...
//                    nil];
    NSArray* types=[[NSArray alloc] initWithObjects:
                    [[NSArray alloc] initWithObjects:CustomLocalizedString(@"invisibleFat", nil),CustomLocalizedString(@"fatty", nil),CustomLocalizedString(@"obese", nil),nil],
                    [[NSArray alloc] initWithObjects:CustomLocalizedString(@"lightlyMuscled", nil),CustomLocalizedString(@"fit", nil),CustomLocalizedString(@"muscular", nil),nil],
                    [[NSArray alloc] initWithObjects:CustomLocalizedString(@"thin", nil),CustomLocalizedString(@"lowFat", nil),CustomLocalizedString(@"athletic", nil),nil],
                    nil];
    double minBmi=18.5;
    double maxBmi=25;
    double minPbf=20;
...
+(NSString*)calcFatLevel:(NSNumber*)bmi
{
    ...
    {
//        result=@"较轻";
        result = CustomLocalizedString(@"underweight", nil);
    }
...
//        result=@"正常";
    ...
    {
//        result=@"超重";
        result = CustomLocalizedString(@"overweight", nil);
    }
    else if(value>=30 && value<35)
    {
//        result=@"肥胖一级";
        result = CustomLocalizedString(@"ObeseClass1", nil);
    }
    else if(value>=35 && value<40)
    {
//        result=@"肥胖二级";
        result = CustomLocalizedString(@"ObeseClass2", nil);
    }
    else
    {
//        result=@"肥胖三级";
        result = CustomLocalizedString(@"ObeseClass3", nil);
    }
    return  result;
}
