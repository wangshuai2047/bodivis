...
{
    PPiFlatSegmentedControl *segmented=[[PPiFlatSegmentedControl alloc] initWithFrame:CGRectMake(10,80, 300, 30) items:@[@{@"text":CustomLocalizedString(@"labelWeek", nil),@"icon":@"icon-time"},@{@"text":CustomLocalizedString(@"labelMonth", nil),@"icon":@"icon-calendar"},@{@"text":CustomLocalizedString(@"labelSeason", nil),@"icon":@"icon-coffee"},@{@"text":CustomLocalizedString(@"labelYear", nil),@"icon":@"icon-cloud-download"}]iconPosition:IconPositionRight andSelectionBlock:^(NSUInteger segmentIndex) {}];
